...
class FlatListItem extends Component{
    constructor(props){
        super(props);
        this.state - {
            activeRowKey: null,                      //lưu lại Key của hàng object muốn xóa
            numberOfRefresh: 0
        };
    }
    refreshFlatListItem = () =>{
    ...
    render() {
        const swipeSettings = {
            ...
            onClose: (secId, rowId, direction) =>{
                if(this.state.activeRowKey != null) {                           //nếu key khác null thì mới = null
...
export default class BasicFlatList extends Component {
    ...
    refreshFlatList = (activeKey) => {                                   //thay đổi state của flatlist
        this.setState((prevState) => {
            return {
    ...
    refreshFlatList1 = (activeKey) => {                                   //thay đổi state của flatlist
        this.setState((prevState) => {
            return {
                deleteRowKey: activeKey
            };
